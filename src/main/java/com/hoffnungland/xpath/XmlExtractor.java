...
public class XmlExtractor {
	...
	public String extractString(XdmItem nodeItem, String xPathStr, String xmlNs) throws SaxonApiException  {
		logger.traceEntry();
	...
	public XdmValue extractNode(XdmItem nodeItem, String xPath, String xmlNs) throws SaxonApiException, IndexOutOfBoundsException, SaxonApiUncheckedException, SAXException, IOException, ParserConfigurationException  {
		logger.traceEntry();
		if(nodeItem.isEmpty() || !nodeItem.isNode()) {
